...
public class GlobalDefaults {
    ...
    public static void loadDefaults() {
        ...
        GLOBAL_DEFAULTS.addProperty("layer.order", null);
        GLOBAL_DEFAULTS.addProperty("main.size.height", Toolkit.getDefaultToolkit().getScreenSize().getWidth() - 50);
        GLOBAL_DEFAULTS.addProperty("main.size.width", Toolkit.getDefaultToolkit().getScreenSize().getHeight() - 50);
        ...
        GLOBAL_DEFAULTS.addProperty("attack.template.header.internal", "/de/tor/tribes/tmpl/attack_header.tmpl");
        GLOBAL_DEFAULTS.addProperty("attack.template.block", "<Standard>");
        GLOBAL_DEFAULTS.addProperty("attack.template.block.internal", "/de/tor/tribes/tmpl/attack_block.tmpl");
        GLOBAL_DEFAULTS.addProperty("attack.template.footer", "<Standard>");
        GLOBAL_DEFAULTS.addProperty("attack.template.footer.internal", "/de/tor/tribes/tmpl/attack_footer.tmpl");
        GLOBAL_DEFAULTS.addProperty("report.list.bbexport.template",
                (new de.tor.tribes.util.bb.ReportListFormatter()).getStandardTemplate());
        ...
        GLOBAL_DEFAULTS.addProperty("ally.report.stats.bbexport.template",
                (new de.tor.tribes.util.bb.AllyReportStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("attack.list.bbexport.template",
                (new de.tor.tribes.util.bb.AttackListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("def.stats.bbexport.template",
                (new de.tor.tribes.util.bb.DefStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("form.list.bbexport.template",
                (new de.tor.tribes.util.bb.FormListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("kills.stats.bbexport.template",
                (new de.tor.tribes.util.bb.KillStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("marker.list.bbexport.template",
                (new de.tor.tribes.util.bb.MarkerListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("note.list.bbexport.template",
                (new de.tor.tribes.util.bb.NoteListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("overall.report.stats.bbexport.template",
                (new de.tor.tribes.util.bb.OverallReportStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("point.stats.bbexport.template",
                (new de.tor.tribes.util.bb.PointStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("report.list.bbexport.template",
                (new de.tor.tribes.util.bb.ReportListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("sos.list.bbexport.template",
                (new de.tor.tribes.util.bb.SosListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("tag.list.bbexport.template",
                (new de.tor.tribes.util.bb.TagListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("tribe.report.stats.bbexport.template",
                (new de.tor.tribes.util.bb.TribeReportStatsFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("troops.list.bbexport.template",
                (new de.tor.tribes.util.bb.TroopListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("village.list.bbexport.template",
                (new de.tor.tribes.util.bb.VillageListFormatter()).getStandardTemplate());
        
        GLOBAL_DEFAULTS.addProperty("winner.loser.stats.bbexport.template",
                (new de.tor.tribes.util.bb.WinnerLoserStatsFormatter()).getStandardTemplate());
    ...
    public static String getProperty(String pKey) {
        if (GLOBAL_DEFAULTS == null || pKey == null) {
            return null;
        }
        String property = GLOBAL_DEFAULTS.getString(pKey);
        if (property != null) {
            return property;
        } else {
            return null;
    ...
    public static PropertiesConfiguration getProperties() {
        if (GLOBAL_DEFAULTS == null) {//return empty properties if not yet loaded
